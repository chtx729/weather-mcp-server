...
var WeatherAPI = class {
  ...
  async getCoordinates(cityName) {
    ...
    try {
      const response = await axios_default.get(`${this.geoUrl}/direct`, {
        params: {
          q: cityName,
          limit: 1,
          appid: this.apiKey
  ...
  async getCurrentWeather(lat, lon, units = "metric", lang = "zh_cn") {
    ...
    try {
      const response = await axios_default.get(`${this.baseUrl}/weather`, {
        params: {
          lat,
          lon,
          appid: this.apiKey,
  ...
  async getForecast(lat, lon, days = 5, units = "metric", lang = "zh_cn") {
    ...
    try {
      const response = await axios_default.get(`${this.baseUrl}/forecast`, {
        params: {
          lat,
          lon,
          appid: this.apiKey,
  ...
  formatCurrentWeather(data) {
    return {
      ...
      current: {
        ...
        visibility: data.visibility / 1e3,
        // 转换为公里
        uvIndex: data.uvi || 0,
        weather: {
      ...
      timestamp: new Date(data.dt * 1e3).toISOString(),
  ...
  formatForecast(data, days) {
    ...
    data.list.forEach((item) => {
      const date = new Date(item.dt * 1e3).toDateString();
...
// src/utils.js
function formatWeatherResponse(data, type) {
  if (type === "current") {
...
function formatCurrentWeatherText(weather) {
  ...
  return `\u{1F30D} ${location.name}, ${location.country}
\u{1F4C5} ${new Date(timestamp).toLocaleString("zh-CN")}

\u{1F321}\uFE0F \u6E29\u5EA6: ${current.temperature}\xB0C (\u4F53\u611F ${current.feelsLike}\xB0C)
\u2601\uFE0F \u5929\u6C14: ${current.weather.description}
\u{1F4A7} \u6E7F\u5EA6: ${current.humidity}%
\u{1F32C}\uFE0F \u98CE\u901F: ${current.wind.speed} m/s
\u{1F4CA} \u6C14\u538B: ${current.pressure} hPa
\u{1F441}\uFE0F \u80FD\u89C1\u5EA6: ${current.visibility} km
\u{1F305} \u65E5\u51FA: ${new Date(sunrise).toLocaleTimeString("zh-CN")}
\u{1F307} \u65E5\u843D: ${new Date(sunset).toLocaleTimeString("zh-CN")}`;
}
function formatForecastText(forecast) {
  const { location, forecast: dailyForecasts } = forecast;
  let text = `\u{1F30D} ${location.name}, ${location.country} - ${dailyForecasts.length}\u5929\u5929\u6C14\u9884\u62A5

`;
  dailyForecasts.forEach((day, index) => {
    const date = new Date(day.date);
    const dayName = index === 0 ? "\u4ECA\u5929" : index === 1 ? "\u660E\u5929" : date.toLocaleDateString("zh-CN", { weekday: "long" });
    text += `\u{1F4C5} ${dayName} (${date.toLocaleDateString("zh-CN")})
`;
    text += `\u{1F321}\uFE0F ${day.temperature.min}\xB0C ~ ${day.temperature.max}\xB0C
`;
    text += `\u2601\uFE0F ${day.weather.description}
`;
    text += `\u{1F4A7} \u6E7F\u5EA6: ${day.humidity}%
`;
    text += `\u{1F32C}\uFE0F \u98CE\u901F: ${day.wind.speed} m/s
...
function registerWeatherTools(server) {
  ...
  server.tool(
    ...
    "\u6839\u636E\u57CE\u5E02\u540D\u79F0\u83B7\u53D6\u5F53\u524D\u5929\u6C14\u4FE1\u606F",
    {
      city: external_exports.string().describe("\u57CE\u5E02\u540D\u79F0\uFF0C\u652F\u6301\u4E2D\u82F1\u6587"),
      units: external_exports.enum(["metric", "imperial", "kelvin"]).optional().describe("\u6E29\u5EA6\u5355\u4F4D\uFF1Ametric(\u6444\u6C0F\u5EA6), imperial(\u534E\u6C0F\u5EA6), kelvin(\u5F00\u5C14\u6587)"),
      lang: external_exports.string().optional().describe("\u8BED\u8A00\u4EE3\u7801\uFF0C\u5982 zh_cn, en \u7B49")
    },
  ...
  server.tool(
    ...
    "\u6839\u636E\u5730\u7406\u5750\u6807\u83B7\u53D6\u5F53\u524D\u5929\u6C14\u4FE1\u606F",
    {
      latitude: external_exports.number().describe("\u7EAC\u5EA6"),
      longitude: external_exports.number().describe("\u7ECF\u5EA6"),
      units: external_exports.enum(["metric", "imperial", "kelvin"]).optional().describe("\u6E29\u5EA6\u5355\u4F4D"),
      lang: external_exports.string().optional().describe("\u8BED\u8A00\u4EE3\u7801")
    },
  ...
  server.tool(
    ...
    "\u83B7\u53D6\u6307\u5B9A\u57CE\u5E02\u7684\u5929\u6C14\u9884\u62A5",
    {
      city: external_exports.string().describe("\u57CE\u5E02\u540D\u79F0"),
      days: external_exports.number().min(1).max(5).optional().describe("\u9884\u62A5\u5929\u6570\uFF0C1-5\u5929"),
      units: external_exports.enum(["metric", "imperial", "kelvin"]).optional().describe("\u6E29\u5EA6\u5355\u4F4D"),
      lang: external_exports.string().optional().describe("\u8BED\u8A00\u4EE3\u7801")
    },
    ...
    async ({ query }) => {
      try {
        ...
        return {
          content: [{
            type: "text",
            text: `\u{1F50D} \u627E\u5230\u57CE\u5E02: ${coordinates.name}, ${coordinates.country}
\u{1F4CD} \u5750\u6807: ${coordinates.lat}, ${coordinates.lon}`
          }]
        };
      } catch (error) {
        return {
  ...
  server.tool(
    ...
    "\u5BF9\u6BD4\u591A\u4E2A\u57CE\u5E02\u7684\u5F53\u524D\u5929\u6C14",
    {
      cities: external_exports.array(external_exports.string()).min(2).max(5).describe("\u8981\u5BF9\u6BD4\u7684\u57CE\u5E02\u5217\u8868\uFF082-5\u4E2A\u57CE\u5E02\uFF09"),
      units: external_exports.enum(["metric", "imperial", "kelvin"]).optional().describe("\u6E29\u5EA6\u5355\u4F4D"),
      lang: external_exports.string().optional().describe("\u8BED\u8A00\u4EE3\u7801")
    },
    async ({ cities, units = "metric", lang = "zh_cn" }) => {
      try {
        ...
        let comparisonText = `\u{1F30D} ${cities.length}\u4E2A\u57CE\u5E02\u5929\u6C14\u5BF9\u6BD4

`;
        results.forEach((weather, index) => {
          const { location, current } = weather;
          comparisonText += `\u{1F4CD} ${location.name}, ${location.country}
`;
          comparisonText += `\u{1F321}\uFE0F ${current.temperature}\xB0C (${current.weather.description})
`;
          comparisonText += `\u{1F4A7} \u6E7F\u5EA6: ${current.humidity}% | \u{1F32C}\uFE0F \u98CE\u901F: ${current.wind.speed} m/s
`;
...
async function main() {
  try {
    ...
    console.error("\u{1F324}\uFE0F \u5929\u6C14\u9884\u62A5 MCP Server \u5DF2\u542F\u52A8");
    console.error("\u{1F4E1} \u7B49\u5F85\u5BA2\u6237\u7AEF\u8FDE\u63A5...");
  } catch (error) {
...
process.on("SIGINT", () => {
  console.error("\n\u{1F6D1} \u6536\u5230\u5173\u95ED\u4FE1\u53F7\uFF0C\u6B63\u5728\u5173\u95ED\u670D\u52A1\u5668...");
  process.exit(0);
});
process.on("SIGTERM", () => {
  console.error("\n\u{1F6D1} \u6536\u5230\u7EC8\u6B62\u4FE1\u53F7\uFF0C\u6B63\u5728\u5173\u95ED\u670D\u52A1\u5668...");
  process.exit(0);
});
